  ...
  return (
    <div className="p-4">
      ...
      <section className="mt-6 rounded-xl border border-teal-200 bg-teal-50 p-5 dark:border-teal-900 dark:bg-teal-950/40">
        <h2 className="font-semibold text-teal-900 dark:text-teal-200">{t('home.phase1')}</h2>
        <p className="mt-1 text-sm text-teal-800 dark:text-teal-300">{t('home.phase1Body')}</p>
      </section>
    </div>
  )
}
